...
public class IPRangeRealm extends AbstractRealm {
	...
	public Subject authenticate(final String ip, Object credentials) throws AuthenticationException {
		...
		try {
            ...
            if (broker == null) {
                LOG.error("Unable to retrieve DBBroker for IPRange");
            }
            ...
            String query = "collection('/db/system/security/IPRange/accounts')/account[number(iprange/start) ge " + ipToTest + " and number(iprange/end) le " + ipToTest + "]/name";
